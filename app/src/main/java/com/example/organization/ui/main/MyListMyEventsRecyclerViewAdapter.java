...
public class MyListMyEventsRecyclerViewAdapter extends RecyclerView.Adapter<MyListMyEventsRecyclerViewAdapter.ViewHolder> {
    ...
    private final ListMyEventsFragment.OnListFragmentInteractionListener mListener;
    ...
    public MyListMyEventsRecyclerViewAdapter(List<Events> events, ListMyEventsFragment.OnListFragmentInteractionListener listener) {
        mValues = events;
        mListener = listener;
